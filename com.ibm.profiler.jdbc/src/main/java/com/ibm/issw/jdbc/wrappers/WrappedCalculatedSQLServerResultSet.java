...
/**
 * WrappedCalculatedSQLServerResultSet
 * 
 * @author Administrator
 */
public class WrappedCalculatedSQLServerResultSet extends WrappedCalculatedResultSet implements ISQLServerResultSet
{
    private final ISQLServerResultSet rslt;

    public WrappedCalculatedSQLServerResultSet(ISQLServerResultSet resultSet, String reference, JdbcEvent event)
    {
